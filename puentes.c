...
Thread_Puente crear_puente_0()
{
    ...
    puente_0 -> capacidad = 5;              // Capacidad, numero de carros en el puente al mismo tiempo
    puente_0 -> control = SEMAFORO;           // Algoritmo de control del puente
    puente_0 -> k = 5;

    puente_0 -> semaforo_izquierda = 1;
    puente_0 -> semaforo_derecha = 0;
    puente_0 -> tiempo_semaforo_izquierda = 4;
    puente_0 -> tiempo_semaforo_derecha = 4;
    ...
    // puente_0->hilo=thread_puente_0;         // Referencio esa instancia al objeto del puente para poder controlar aspectos del hilo
...
Thread_Puente crear_puente_1()
{
    ...
    puente_1 -> control =SEMAFORO;            // Algoritmo de control del puente
    puente_1 -> k =5;

    puente_1 -> semaforo_izquierda = 1;
    puente_1 -> semaforo_derecha = 0;
    puente_1 -> tiempo_semaforo_izquierda = 4;
    puente_1 -> tiempo_semaforo_derecha = 4;
    ...
    // puente_1->hilo=thread_puente_1;         // Referencio esa instancia al objeto del puente para poder controlar aspectos del hilo
...
Thread_Puente crear_puente_2()
{
    ...
    puente_2 -> capacidad = 9;              // Capacidad, numero de carros en el puente al mismo tiempo
    puente_2 -> control = SEMAFORO;            // Algoritmo de control del puente
    puente_2 -> k = 10;

    puente_2 -> semaforo_izquierda = 1;
    puente_2 -> semaforo_derecha = 0;
    puente_2 -> tiempo_semaforo_izquierda = 4;
    puente_2 -> tiempo_semaforo_derecha = 4;
...
Thread_Puente crear_puente_3()
{
    ...
    puente_3 -> capacidad = 15;              // Capacidad, numero de carros en el puente al mismo tiempo
    puente_3 -> control = SEMAFORO;            // Algoritmo de control del puente
    puente_3 -> k = 7;

    puente_3 -> semaforo_izquierda = 1;
    puente_3 -> semaforo_derecha = 0;
    puente_3 -> tiempo_semaforo_izquierda = 4;
    puente_3 -> tiempo_semaforo_derecha = 4;
